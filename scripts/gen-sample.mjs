...
const intro = [
  ...
  ...filler('intro', 8, 1),
  comp('b1', 'body', 'done', '★ HUB b1 — trace to b2 (detail), b4 (appendix), b6 (detail page)'),
  ...filler('intro', 6, 9),
  comp(
    'mega5',
    'body',
...
const detail = [
  ...
  ...filler('detail', 10, 1),
  comp('b2', 'body', 'working', '★ HUB b2 — 4 pages: intro, detail, appendix, specs'),
  ...filler('detail', 6, 11),
  ...
  ...filler('detail', 8, 29),
  comp('b6', 'body', 'done', '★ b6 — linked to b1 and b2 (same page as b2)'),
  ...filler('detail', 8, 37),
...
const appendix = [
  ...
  comp('b7', 'body', 'working', '★ b7 — linked to b2, b9; referenced by b3'),
...
const specs = [
  ...
  ...filler('specs', 6, 19),
  comp('b8', 'body', 'working', '★ b8 — linked to b2 on detail.p'),
  ...filler('specs', 8, 25),
